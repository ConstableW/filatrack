    ...
    return (<div className="w-full flex items-center justify-center">
        <div className="w-[95%] md:w-2/3 bg-bg-light rounded-lg p-5">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to Filatrack, accessible from <a href="https://filatrack.vercel.app" rel="external nofollow noopener" target="_blank">https://filatrack.vercel.app</a></p>
                </li>
                <li>
